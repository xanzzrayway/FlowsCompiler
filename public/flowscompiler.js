        ...
        const translations = {
            id: {
                ...
                perm_search_placeholder: "Cari izin... (mis: kamera / CAMERA)",
                perm_no_result: "Tidak ada izin yang cocok.",
                upgrade_pill: "Upgrade Ke Pro",
                upgrade_title: "Upgrade Ke Pro",
                upgrade_feat_limit: "Limit 0/5",
                upgrade_feat_speed: "10x Lebih Cepat Compile",
                upgrade_feat_price: "Harga Mulai 8-16K",
                contact_title: "Hubungi Penjual Dengan Telegram",
                contact_close: "Tutup",
                loading_text: "Menyiapkan Compiler...",
            },
            en: {
                ...
                perm_search_placeholder: "Search permissions... (e.g. camera / CAMERA)",
                perm_no_result: "No matching permissions found.",
                upgrade_pill: "Upgrade To Pro",
                upgrade_title: "Upgrade To Pro",
                upgrade_feat_limit: "Limit 0/5",
                upgrade_feat_speed: "10x Faster Compile",
                upgrade_feat_price: "Starting From 8-16K",
                contact_title: "Contact Seller On Telegram",
                contact_close: "Close",
                loading_text: "Preparing Compiler...",
            },
            ms: {
                ...
                perm_search_placeholder: "Cari kebenaran... (cth: kamera / CAMERA)",
                perm_no_result: "Tiada kebenaran yang sepadan.",
                upgrade_pill: "Naik Taraf Ke Pro",
                upgrade_title: "Naik Taraf Ke Pro",
                upgrade_feat_limit: "Had 0/5",
                upgrade_feat_speed: "Kompil 10x Lebih Laju",
                upgrade_feat_price: "Harga Bermula 8-16K",
                contact_title: "Hubungi Penjual Melalui Telegram",
                contact_close: "Tutup",
                loading_text: "Menyediakan Compiler...",
            },
            hi: {
                ...
                perm_search_placeholder: "अनुमति खोजें... (जैसे: कैमरा / CAMERA)",
                perm_no_result: "कोई मेल खाने वाली अनुमति नहीं मिली।",
                upgrade_pill: "Pro में अपग्रेड करें",
                upgrade_title: "Pro में अपग्रेड करें",
                upgrade_feat_limit: "सीमा 0/5",
                upgrade_feat_speed: "10x तेज़ कंपाइल",
                upgrade_feat_price: "कीमत 8-16K से शुरू",
                contact_title: "टेलीग्राम पर विक्रेता से संपर्क करें",
                contact_close: "बंद करें",
                loading_text: "कंपाइलर तैयार हो रहा है...",
            },
            ja: {
                ...
                perm_search_placeholder: "権限を検索...（例：カメラ / CAMERA）",
                perm_no_result: "一致する権限が見つかりません。",
                upgrade_pill: "Proにアップグレード",
                upgrade_title: "Proにアップグレード",
                upgrade_feat_limit: "制限 0/5",
                upgrade_feat_speed: "コンパイルが10倍速い",
                upgrade_feat_price: "価格 8-16Kから",
                contact_title: "Telegramで販売者に連絡",
                contact_close: "閉じる",
                loading_text: "コンパイラを準備中...",
            },
            ko: {
                ...
                perm_search_placeholder: "권한 검색... (예: 카메라 / CAMERA)",
                perm_no_result: "일치하는 권한이 없습니다.",
                upgrade_pill: "Pro로 업그레이드",
                upgrade_title: "Pro로 업그레이드",
                upgrade_feat_limit: "한도 0/5",
                upgrade_feat_speed: "10배 빠른 컴파일",
                upgrade_feat_price: "가격 8-16K부터",
                contact_title: "텔레그램으로 판매자에게 문의",
                contact_close: "닫기",
                loading_text: "컴파일러 준비 중...",
            },
            zh: {
                ...
                perm_search_placeholder: "搜索权限...（例如：相机 / CAMERA）",
                perm_no_result: "未找到匹配的权限。",
                upgrade_pill: "升级到 Pro",
                upgrade_title: "升级到 Pro",
                upgrade_feat_limit: "限额 0/5",
                upgrade_feat_speed: "编译速度快10倍",
                upgrade_feat_price: "价格从 8-16K 起",
                contact_title: "通过 Telegram 联系卖家",
                contact_close: "关闭",
                loading_text: "正在准备编译器...",
            },
            ar: {
                ...
                perm_search_placeholder: "ابحث عن الأذونات... (مثال: الكاميرا / CAMERA)",
                perm_no_result: "لا توجد أذونات مطابقة.",
                upgrade_pill: "الترقية إلى Pro",
                upgrade_title: "الترقية إلى Pro",
                upgrade_feat_limit: "الحد 0/5",
                upgrade_feat_speed: "تحويل أسرع بـ 10 مرات",
                upgrade_feat_price: "السعر يبدأ من 8-16K",
                contact_title: "تواصل مع البائع عبر تيليجرام",
                contact_close: "إغلاق",
                loading_text: "جارٍ تجهيز المُجمِّع...",
            },
            de: {
                ...
                perm_search_placeholder: "Berechtigungen suchen... (z. B. Kamera / CAMERA)",
                perm_no_result: "Keine passenden Berechtigungen gefunden.",
                upgrade_pill: "Auf Pro upgraden",
                upgrade_title: "Auf Pro upgraden",
                upgrade_feat_limit: "Limit 0/5",
                upgrade_feat_speed: "10x schnelleres Kompilieren",
                upgrade_feat_price: "Preis ab 8-16K",
                contact_title: "Verkäufer über Telegram kontaktieren",
                contact_close: "Schließen",
                loading_text: "Compiler wird vorbereitet...",
            },
            fr: {
                ...
                perm_search_placeholder: "Rechercher une autorisation... (ex. caméra / CAMERA)",
                perm_no_result: "Aucune autorisation correspondante.",
                upgrade_pill: "Passer à Pro",
                upgrade_title: "Passer à Pro",
                upgrade_feat_limit: "Limite 0/5",
                upgrade_feat_speed: "Compilation 10x plus rapide",
                upgrade_feat_price: "Prix à partir de 8-16K",
                contact_title: "Contacter le vendeur sur Telegram",
                contact_close: "Fermer",
                loading_text: "Préparation du compilateur...",
            },
            es: {
                ...
                perm_search_placeholder: "Buscar permiso... (ej. cámara / CAMERA)",
                perm_no_result: "No se encontraron permisos coincidentes.",
                upgrade_pill: "Actualizar a Pro",
                upgrade_title: "Actualizar a Pro",
                upgrade_feat_limit: "Límite 0/5",
                upgrade_feat_speed: "Compilación 10 veces más rápida",
                upgrade_feat_price: "Precio desde 8-16K",
                contact_title: "Contactar al vendedor por Telegram",
                contact_close: "Cerrar",
                loading_text: "Preparando el compilador...",
            },
            pt: {
                ...
                perm_search_placeholder: "Buscar permissão... (ex. câmera / CAMERA)",
                perm_no_result: "Nenhuma permissão correspondente encontrada.",
                upgrade_pill: "Atualizar para Pro",
                upgrade_title: "Atualizar para Pro",
                upgrade_feat_limit: "Limite 0/5",
                upgrade_feat_speed: "Compilação 10x mais rápida",
                upgrade_feat_price: "Preço a partir de 8-16K",
                contact_title: "Contatar vendedor pelo Telegram",
                contact_close: "Fechar",
                loading_text: "Preparando o compilador...",
            },
            ru: {
                ...
                perm_search_placeholder: "Поиск разрешений... (напр. камера / CAMERA)",
                perm_no_result: "Совпадающих разрешений не найдено.",
                upgrade_pill: "Перейти на Pro",
                upgrade_title: "Перейти на Pro",
                upgrade_feat_limit: "Лимит 0/5",
                upgrade_feat_speed: "Компиляция в 10 раз быстрее",
                upgrade_feat_price: "Цена от 8-16K",
                contact_title: "Связаться с продавцом в Telegram",
                contact_close: "Закрыть",
                loading_text: "Подготовка компилятора...",
            },
            vi: {
                ...
                perm_search_placeholder: "Tìm quyền... (vd: máy ảnh / CAMERA)",
                perm_no_result: "Không tìm thấy quyền phù hợp.",
                upgrade_pill: "Nâng Cấp Lên Pro",
                upgrade_title: "Nâng Cấp Lên Pro",
                upgrade_feat_limit: "Giới hạn 0/5",
                upgrade_feat_speed: "Biên dịch nhanh hơn 10 lần",
                upgrade_feat_price: "Giá từ 8-16K",
                contact_title: "Liên hệ người bán qua Telegram",
                contact_close: "Đóng",
                loading_text: "Đang chuẩn bị trình biên dịch...",
            },
            th: {
                ...
                perm_search_placeholder: "ค้นหาสิทธิ์... (เช่น กล้อง / CAMERA)",
                perm_no_result: "ไม่พบสิทธิ์ที่ตรงกัน",
                upgrade_pill: "อัปเกรดเป็น Pro",
                upgrade_title: "อัปเกรดเป็น Pro",
                upgrade_feat_limit: "โควตา 0/5",
                upgrade_feat_speed: "คอมไพล์เร็วขึ้น 10 เท่า",
                upgrade_feat_price: "ราคาเริ่มต้น 8-16K",
                contact_title: "ติดต่อผู้ขายทาง Telegram",
                contact_close: "ปิด",
                loading_text: "กำลังเตรียมตัวคอมไพล์...",
            },
            tl: {
                ...
                perm_search_placeholder: "Maghanap ng pahintulot... (hal: camera / CAMERA)",
                perm_no_result: "Walang nahanap na tugmang pahintulot.",
                upgrade_pill: "Mag-upgrade Sa Pro",
                upgrade_title: "Mag-upgrade Sa Pro",
                upgrade_feat_limit: "Limitasyon 0/5",
                upgrade_feat_speed: "10x Mas Mabilis Mag-compile",
                upgrade_feat_price: "Presyo Mula 8-16K",
                contact_title: "Kontakin Ang Nagbebenta Sa Telegram",
                contact_close: "Isara",
                loading_text: "Inihahanda ang Compiler...",
            },
            nl: {
                ...
                perm_search_placeholder: "Machtiging zoeken... (bijv. camera / CAMERA)",
                perm_no_result: "Geen overeenkomende machtigingen gevonden.",
                upgrade_pill: "Upgraden Naar Pro",
                upgrade_title: "Upgraden Naar Pro",
                upgrade_feat_limit: "Limiet 0/5",
                upgrade_feat_speed: "10x Snellere Compilatie",
                upgrade_feat_price: "Prijs Vanaf 8-16K",
                contact_title: "Neem Contact Op Met Verkoper Via Telegram",
                contact_close: "Sluiten",
                loading_text: "Compiler wordt voorbereid...",
            },
        };
        ...
        async function ensureUsageRow() {
            ...
            if (error) {
                ...
                currentUsage = { today_count: 0, usage_date: todayStr(), daily_limit: DAILY_LIMIT, plan: 'default' };
                return;
            }
            ...
            if (!data) {
                const { data: inserted, error: insErr } = await sb
                    .from('usage')
                    .insert({ user_id: currentUser.id, email: currentUser.email, daily_limit: DAILY_LIMIT, today_count: 0, usage_date: todayStr(), plan: 'default' })
                    .select()
                    .single();
                currentUsage = insErr ? { today_count: 0, usage_date: todayStr(), daily_limit: DAILY_LIMIT, plan: 'default' } : inserted;
                return;
            }
        ...
        function refreshLimitDisplay() {
            ...
            document.getElementById('display-limit').innerText = `${currentUsage.today_count}/${effectiveDailyLimit()} Compile`;
            updateUpgradePillVisibility();
        }

        // Sembunyikan pill "Upgrade Ke Pro" kalau user sudah plan pro (nggak relevan lagi buat di-upgrade)
        function updateUpgradePillVisibility() {
            const pill = document.getElementById('upgrade-pill-container');
            if (!pill) return;
            const isPro = currentUsage && currentUsage.plan === 'pro';
            pill.classList.toggle('hidden', isPro);
        }
        ...
        function canBuildNow() {
            ...
            if (currentUsage.today_count >= effectiveDailyLimit()) {
        ...
        // -- Pencarian izin (cocokkan nama terjemahan ATAU kode asli Android) --
        function filterPermissions() {
            const query = document.getElementById('perm-search-input').value.trim().toLowerCase();
            const clearBtn = document.getElementById('perm-search-clear');
            clearBtn.classList.toggle('hidden', query === '');

            const items = document.querySelectorAll('#permissions-box .perm-item');
            let visibleCount = 0;
            ...
            document.getElementById('perm-no-result').classList.toggle('hidden', visibleCount > 0);
        }
        ...
        // -- Loading Screen (logo + progress bar 3 detik di awal buka web) --
        function initLoadingScreen() {
            const bar = document.getElementById('loading-progress-bar');
            const screen = document.getElementById('loading-screen');
            if (!bar || !screen) return;

            // requestAnimationFrame supaya transisi CSS width beneran ke-trigger
        ...
        // --- Screen Upgrade Ke Pro & Modal Kontak Penjual ---

        let upgradePreviousScreenId = 'screen-login';

        function openUpgradeScreen() {
            const compilerScreen = document.getElementById('screen-compiler');
            const loginScreen = document.getElementById('screen-login');

            if (compilerScreen && !compilerScreen.classList.contains('hidden')) {
                upgradePreviousScreenId = 'screen-compiler';
                compilerScreen.classList.add('hidden');
            } else if (loginScreen) {
                upgradePreviousScreenId = 'screen-login';
        ...
        function closeUpgradeScreen() {
            ...
            const prevScreen = document.getElementById(upgradePreviousScreenId);
        ...
        function pollStatus(buildId) {
            ...
            const MAX_RELEASE_RETRIES = 20; // ~80 detik toleransi lag sinkronisasi GitHub Release API
